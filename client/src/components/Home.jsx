          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <ul className="mt-4 text-gray-400 space-y-2">
                <li><a href="https://github.com/himanshu8github" className="hover:text-white flex items-center gap-1"><DiGithubBadge /> himanshu8github</a></li>
                <li><a href="https://www.linkedin.com/in/himanshu-choudhary-1a19ba255/" className="hover:text-white flex items-center gap-1"><FaLinkedin /> himanshu-choudhary</a></li>
              </ul>
            </div>
            <div className="flex flex-col items-center">
